...
class MY_Model extends CI_Model
{
    ...
    public function get_question($primary_value){
       ...
       $data_survey = 'survey_id';
        ...
        $row = $this->_database->where($data_survey, $primary_value)
                        ->get($this->_table)
                        ->{$this->_return_type()}();
        $this->_temporary_return_type = $this->return_type;
        ...
        public function get_choices($primary_value){
        
        $data_question = 'question_id';
        ...
        $row = $this->_database->where($data_question, $primary_value)
                        ->get($this->_table)
                        ->{$this->_return_type()}();
        $this->_temporary_return_type = $this->return_type;
...
//			$id = $filter($id);
    ...
    public function get_all_questions($primary_value)
    {
        ...
        $result = $this->_database-> where($data_survey, $primary_value)
                ->get($this->_table)
                           ->{$this->_return_type(1)}();
        $this->_temporary_return_type = $this->return_type;
       ...
       public function get_all_choices($primary_value)
    {
            $data_question = 'question_id';
        $this->trigger('before_get');
        ...
        $result = $this->_database-> where($data_question, $primary_value)
                                ->get($this->_table)
                           ->{$this->_return_type(1)}();
        $this->_temporary_return_type = $this->return_type;
