...
<head>
	...
	<!-- Semantic -->
                ...
                <link href="<?php echo base_url('dtables/media/css/jquery.dataTables_themeroller.css'); ?>" rel="stylesheet/less">
                <link href="<?php echo base_url('dtables/media/css/jquery.dataTables.css'); ?>" rel="stylesheet/less">
